    ...
    <>
      ...
      >
        <div style={{ textAlign: "center", maxWidth: 500, padding: 40 }}>
          ...
          >
            ဒါက <strong>အတု Facebook login page</strong> ဖြစ်ပါတယ်။ ဒါက
            တကယ့် phishing page ဖြစ်ခဲ့ရင် hacker က သင့် credentials ကို
            ရသွားပါပြီ။
          </p>
          <div
            style={{
          ...
          >
            ...
            >
              <li>URL ကို အမြဲစစ်ဆေးပါ — ဒါက facebook.com မဟုတ်ပါဘူး</li>
          ...
          >
            ...
            >
              ...
              Facebook website ကို အလိုအလျောက် redirect လုပ်ပေးပါတယ်။
...
export default function FacebookHackedPage() {
  return (
